...
def gem_path(name):
    if name == 'empty':
        ...
        # llsif.win doesn't have sprites for latest gems
        name = name.replace('Bloom', 'Aura')
        name = name.replace('Wink', 'Perfume')
        name = name.replace('Trill', 'Cross')
...
def misc_path(name):
    url_dict = {
        ...
        'Weak Judge': 'https://card.niconi.co.ni/asset/assets/image/ui/live/l_skill_02.png',
        'Strong Judge': 'https://card.niconi.co.ni/asset/assets/image/ui/live/l_skill_01.png',
        'Score Up': 'https://card.niconi.co.ni/asset/assets/image/ui/live/l_skill_03.png',
        'Stamina Restore': 'https://card.niconi.co.ni/static/images/skilllifeup.png',
