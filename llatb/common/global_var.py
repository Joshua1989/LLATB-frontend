...
gem_skill_dict = {'Smile Kiss': 		{'attribute':'Smile',	'constraint':None,			'cost':1,	'effect':'attr_add',	'value': 200},
				  ...
				  'Smile Wink': 		{'attribute':'Smile',	'constraint':None,			'cost':5,	'effect':'attr_add',	'value': 1400},
				  'Pure Wink': 			{'attribute':'Pure',	'constraint':None,			'cost':5,	'effect':'attr_add',	'value': 1400},
				  'Cool Wink': 			{'attribute':'Cool',	'constraint':None,			'cost':5,	'effect':'attr_add',	'value': 1400},
				  'Smile Trill (1st)': 	{'attribute':'Smile',	'constraint':'1st-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Pure Trill (1st)': 	{'attribute':'Pure',	'constraint':'1st-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Cool Trill (1st)': 	{'attribute':'Cool',	'constraint':'1st-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Smile Trill (2nd)': 	{'attribute':'Smile',	'constraint':'2nd-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Pure Trill (2nd)': 	{'attribute':'Pure',	'constraint':'2nd-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Cool Trill (2nd)': 	{'attribute':'Cool',	'constraint':'2nd-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Smile Trill (3rd)': 	{'attribute':'Smile',	'constraint':'3rd-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Pure Trill (3rd)': 	{'attribute':'Pure',	'constraint':'3rd-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
				  'Cool Trill (3rd)': 	{'attribute':'Cool',	'constraint':'3rd-year',	'cost':5,	'effect':'attr_boost',	'value': 28.0},
...
gem_skill_id_dict = { 1:'Smile Kiss',		 	 2:'Pure Kiss',				 3:'Cool Kiss',
					 ...
					 40:'Smile Wink',			41:'Pure Wink',				42:'Cool Wink',
					 43:'Smile Trill (1st)',	44:'Pure Trill (1st)',		45:'Cool Trill (1st)',
					 46:'Smile Trill (2nd)',	47:'Pure Trill (2nd)',		48:'Cool Trill (2nd)',
					 49:'Smile Trill (3rd)',	50:'Pure Trill (3rd)',		51:'Cool Trill (3rd)',
